...
declare namespace languages.css {    export interface CSSFormatConfiguration {
...
declare namespace languages.html {    export interface HTMLFormatConfiguration {
        readonly tabSize: number;
        readonly insertSpaces: boolean;
...
declare namespace languages.json {    export interface BaseASTNode {
...
declare namespace languages.typescript {    export enum ModuleKind {
        None = 0,
        CommonJS = 1,
        AMD = 2,
        UMD = 3,
